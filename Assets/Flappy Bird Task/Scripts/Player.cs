...
namespace FlappyBird
{
    ...
    {        
        ...
        void Flap()
        {
            if (GameManager.instance.currentGameState != GameState.PostGame && this.transform.position.y < maxHeight) // if the game state is game and the bird is below max height
            {
